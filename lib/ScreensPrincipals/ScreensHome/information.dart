...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    String numberformat =
        NumberFormat('#,###').format((widget.property.rentalPrice));
    return Scaffold(
                  ...
                  RichText(
                    text: TextSpan(
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text: widget.property.numberBathrooms.toString(),
                          style: const TextStyle(
                            color: Colors.blue,
                            fontSize: 15,
                          ),
                        ...
                        TextSpan(
                          text: widget.property.numberRooms.toString(),
                          style: const TextStyle(
                            color: Colors.blue,
                            fontSize: 15,
                          ),
                    ...
                    child: TextButton(
                        onPressed: () {
                          Provider.of<StatusProvider>(context, listen: false)
                              .addSelectedProperty(
                                  widget.property, widget.imageUrl);
                          Navigator.pop(context);
