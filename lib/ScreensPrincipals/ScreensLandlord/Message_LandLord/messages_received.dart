...
class MessageReceivedLandLord extends StatefulWidget {
  const MessageReceivedLandLord({Key? key}) : super(key: key);

  @override
  State<MessageReceivedLandLord> createState() => _MessageReceivedLandLordState();
}

class _MessageReceivedLandLordState extends State<MessageReceivedLandLord> {
  @override
