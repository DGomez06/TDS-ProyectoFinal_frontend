    ...
    return Scaffold(
      ...
      return Container(
          ...
          child: Stack(
            ...
            child: SlideInDown(
                child: const Image(image: AssetImage('assets/Ellipse.png'))),
          ),
          AnimatedPositioned(
            bottom: 0,
            right: 0,
            ...
            child: SlideInUp(
                child:
                    const Image(image: AssetImage('assets/Ellipse-down.png'))),
          ),
                  ...
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      child: FittedBox(
                        fit: BoxFit.contain,
                        child: Text(
                          containerVisibility.hideContainer ? 'Registro' : 'Inicio de Sesion',
                    ...
                    AnimatedToggleSwitch.size(
                      ...
                      style: ToggleStyle(
                        ...
                        indicatorBorder: Border.all(width: 0.8, color: Colors.grey),
                      ),
                      borderWidth: 0.5,
                      height: 60,
                      iconOpacity: 1,
                      ...
                      customIconBuilder: (context, local, global) {
                        final text = ['Iniciar Sesion', 'Registrate'][local.index];
                        return Center(
                          child: Text(text,
                              style: GoogleFonts.yaldevi(
                                  fontWeight: FontWeight.bold,
